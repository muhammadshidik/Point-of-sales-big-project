                    ...
                    if (mysqli_num_rows($result) > 0) :
                        while ($row = mysqli_fetch_assoc($result)) : ?>
                            <tr>
                                ...
                                <?php $status = getOrderStatus($row['stok']) ?>
                                <td><?= $status ?></td>
                                <td>
                                    <?php
                                ...
                                <td><button class="btn btn-sm dropdown-toggle more-horizontal" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        <a class="dropdown-item" href="?page=add-produk&edit=<?= $row['id'] ?>">Edit</a>
                                        <a class="dropdown-item" href="?page=add-produk&delete=<?= $row['id'] ?>" class="btn btn-danger btn-sm" onclick="return confirm('Yakin hapus menu ini?')">Remove</a>
