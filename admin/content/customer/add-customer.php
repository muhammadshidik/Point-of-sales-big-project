...
if (isset($_GET['delete'])) {
    ...
    header("Location: ?page=customer/customer&delete=success");
    die;
    ...
    if (isset($_POST['edit'])) {
        ...
        header("Location: ?page=customer/customer&edit=success");
        die;
    }
    ...
    header("Location: ?page=customer/customer&add=success");
    die;
}
?>
        ...
        <form action="" method="post">
            <div class="row">
                ...
                <div class="col-sm-6 mb-3">
                    ...
                    <input type="text" class="form-control" id="" name="phone" placeholder="Masukkan Nomor Telepon"
                        value="<?= isset($_GET['edit']) ? $rowEdit['phone'] : '' ?>" required>
                </div>
                <div class="col-sm-6 mb-3">
                    <label for="" class="form-label">Alamat</label>
                    <textarea name="address" id="" class="form-control"
                        placeholder="Alamat Pelanggan"><?= isset($_GET['edit']) ? $rowEdit['address'] : '' ?></textarea>
                </div>
            </div>
            <div class="">
