...
if (isset($_GET['delete'])) {
    ...
    $query = mysqli_query($config, "DELETE FROM supplier WHERE id_supplier='$idDelete'");
    header("Location: ?page=supplier/supplier&delete=success");
    die;
} else if (isset($_GET['edit'])) {
    $idEdit = $_GET['edit'];
    $queryEdit = mysqli_query($config, "SELECT * FROM supplier WHERE id_supplier='$idEdit'");
    ...
    if (isset($_POST['edit'])) {
        ...
        $alamat = $_POST['alamat'];
        $email = $_POST['email'];
        $queryEdit = mysqli_query($config, "UPDATE supplier SET nama_supplier='$nama_supplier', no_telp='$no_telp',alamat='$alamat', email='$email'  WHERE id_supplier='$idEdit'");
    ...
    $alamat = $_POST['alamat'];
    $email = $_POST['email'];
    mysqli_query($config, "INSERT INTO supplier (nama_supplier, alamat, no_telp, email) VALUES ('$nama_supplier', '$alamat', '$no_telp', '$email')");
...
<div class="container">
    <div class="card shadow">
        <div class="card-header">
            <h3><?= isset($_GET['edit']) ? 'Edit' : 'Add' ?> supplier Barang</h3>
        </div>
        <div class="card-body">
            <form method="POST">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <input type="number" name="no_telp" class="form-control" placeholder="Masukkan No. Telepon" value="<?= isset($rowEdit['no_telp']) ? $rowEdit['no_telp'] : '' ?>" required>
                </div>
                <div class="mb-3">
